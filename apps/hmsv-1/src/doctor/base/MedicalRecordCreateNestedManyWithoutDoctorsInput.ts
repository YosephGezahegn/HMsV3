...
@InputType()
class MedicalRecordCreateNestedManyWithoutDoctorsInput {
...
export { MedicalRecordCreateNestedManyWithoutDoctorsInput as MedicalRecordCreateNestedManyWithoutDoctorsInput };
