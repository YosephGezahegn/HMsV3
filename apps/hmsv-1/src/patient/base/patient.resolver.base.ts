...
export class PatientResolverBase {
  ...
  @graphql.ResolveField(() => [MedicalRecord], { name: "medicalRecords" })
  async findMedicalRecords(
    @graphql.Parent() parent: Patient,
    @graphql.Args() args: MedicalRecordFindManyArgs
  ): Promise<MedicalRecord[]> {
    const results = await this.service.findMedicalRecords(parent.id, args);
  ...
  async getUser(@graphql.Parent() parent: Patient): Promise<User | null> {
